...
class MovieCard extends Component<PropsMovieCard, StateMovieCard> {
    constructor(props: PropsMovieCard) {
        ...
        // Image.getSize("https://image.tmdb.org/t/p/w500/fiVW06jE7z9YnO4trhaMEdclSiC.jpg", (width, height) => { this.setState({ width: width * (height / width), height }) });
        Image.getSize("https://image.tmdb.org/t/p/w500/fiVW06jE7z9YnO4trhaMEdclSiC.jpg", (srcWidth, srcHeight) => {
        ...
        return (
            <View>
                <View style={MovieCardStyle.wrapper}>
                    <Image
                        resizeMode="cover"
                        source={{ uri: 'https://image.tmdb.org/t/p/w500/7Md3nuV0ZprBTnkdR3OrUCEsrSP.jpg' }}
                        style={{
                            width: null, height,
                            overflow: "hidden",
                            borderRadius: 4
                    ...
                    <View style={MovieCardStyle.genreContainer}>
                        <Text style={MovieCardStyle.genreText}>Action | Drama | Science Froction | Science Froction</Text>
                    </View>
                </View>
